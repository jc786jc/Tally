...
erDiagram
  ...
  SB_STRATEGY ||--o{ SB_SUB_STRATEGY : contains
  SB_SUB_STRATEGY ||--o{ SB_RUN_MASTER : contains
  SB_STRATEGY ||--o{ SB_ACCESS_MASTER : controls
  ...
  SB_USER_MASTER ||--o{ SB_STRATEGY : created-by
```
